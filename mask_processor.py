...
def _apply_strength_profile(config: Optional[Dict]) -> Dict:
    ...
    profiles = {
        "light": {
            ...
            "band_end_gap_close_m": 0.25,
            "band_end_guard_m": 0.8,
            "row_gap_close_m": 1.4,
        ...
        "strong": {
            ...
            "band_end_gap_close_m": 0.40,
            "band_end_guard_m": 1.2,
            "row_gap_close_m": 2.8,
        ...
        "very_strong": {
            ...
            "band_end_gap_close_m": 0.50,
            "band_end_guard_m": 1.4,
            "row_gap_close_m": 3.4,
...
def process_mask(raw_mask: np.ndarray,
    ...
    uncertain_residual_mask = np.zeros_like(mask)
    return {
        "processed_mask": mask,
